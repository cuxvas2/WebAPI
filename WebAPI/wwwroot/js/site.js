//URL de la ubicacion de la ap
const uri = 'api/alumnos';
//Variable que trae el arreglo de elementos obtenidos
let todos = [];
...
//Funcion mostrar el formulario de edicion de un alumno
...
//Funcion para concelar la edicion de un alumno
function closeInput() {
    document.getElementById('editForm').style.display = 'none';
}

//Funcion que despliega el número de alumnos encontrados
...
//Funcion que despliega la tabla con alumnos
